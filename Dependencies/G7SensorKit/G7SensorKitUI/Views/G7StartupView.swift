...
struct G7StartupView: View {
    ...
    var body: some View {
        VStack(alignment: .center, spacing: 20) {
            ...
            Text(LocalizedString("ezFCL can read G7 CGM data, but you must still use the Dexcom G7 App for pairing, calibration, and other sensor management.", comment: "Descriptive text on G7StartupView"))
