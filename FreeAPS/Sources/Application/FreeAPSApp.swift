...
@main struct FreeAPSApp: App {
    ...
    init() {
        debug(
            .default,
            "ezFCL Started: v\(Bundle.main.releaseVersionNumber ?? "")(\(Bundle.main.buildVersionNumber ?? "")) [buildDate: \(Bundle.main.buildDate)] [buildExpires: \(Bundle.main.profileExpiration)]"
        )
        loadServices()
    }
